...
<head>
    ...
    <title>SIEGE - Informações para Alunos e Pais </title>
...
<body>
    ...
    <h1 class="titulo-principal"> Informações para Alunos e Pais </h1>

    <p style="margin-top: 25px;"> Nessa página será mostrada as informações para os Alunos e os Pais </p>
</body>
