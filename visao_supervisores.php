...
<head>
    ...
    <title>SIEGE - Visão para supervisores </title>
    ...
    <div class="flex-container">
        ...
        <main>
            ...
            flex-flow: row nowrap; justify-content: center;">
                <h1 class="titulo-principal"> Página principal para supervisor </h1>
            </div>
            <p>Nesta página irá conter a visão inicial dos supervisores, com o menu para abrir cada aba(alterar notas,
