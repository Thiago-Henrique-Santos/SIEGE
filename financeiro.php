...
<body>
    ...
    <h1 class="titulo-principal"> Financeiro </h1>

    <p style="margin-top: 25px;"> Nessa página estará contido todo o conteúdo e funções disponíveis para quem trabalha
        na parte financeira.</p>
</body>
