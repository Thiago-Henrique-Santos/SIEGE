...
<head>
    ...
    <title>SIEGE - Educação para a Vida</title>
...
<body>
    ...
    <section>
            ...
            <div class="card mb-3" style="max-width: 50%;">
                ...
                <p class="card-text">Palestra com a equipe AÇÃO SOCIAL, CREAS E CRAS de Ouro Fino, com as psicólogas Jéssica e Danieli</p> </div>
            </div>
            ...
            <div class="card mb-3" style="max-width: 50%;">
                ...
                <p class="card-text">Debate realizado com a representante da ACAMARE,  a senhora Adriana.</p> </div>
            </div>
            ...
            <div class="card mb-3" style="max-width: 50%;">
                ...
                <p class="card-text">Aula interativa com Anos Inicias sob a responsabilidade das dentistas Lucilene e Viviane</p> </div>
            </div>
