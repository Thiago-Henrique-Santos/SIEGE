...
<body>
    ...
    <div class="flex-container">
        ...
        <section>
        <p>A E.E. Professor Juvenal Brandão conquistou nos últimos anos o primeiro lugar Municipal e Regional da Gincana do Saber. A Gincana do Saber é um jogo entre escolas, de perguntas e respostas, de caráter educativo e não competitivo, em que todos saem ganhando conhecimento sobre a Constituição Federal de uma forma divertida, através da publicação Constituição em Miúdos.</p>
         <div class="card mb-3" style="max-width: 50%;">
          ...
          <div class="card mb-3" style="max-width: 50%;">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Os alunos Kelvin e Maria Luísa representaram a escola na fase municipal e obtiveram êxito.</p></div>
          </div>
          <p> Liderados pelo professor Flávio, os alunos ficaram por semanas estudando e treinando. Com muito trabalho e dedicação, as duplas se sairam muito bem, ultrapassando as pontuações concorrentes e conquistando os primeiros lugares na gincana.
