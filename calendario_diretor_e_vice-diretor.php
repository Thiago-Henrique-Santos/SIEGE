...
<head>
    ...
    <title>SIEGE - Calendário para Diretor e Vice-Diretor </title>
...
<body>
    ...
    <h1 class="titulo-principal"> Calendário para Diretores e Vice-Diretores </h1>

    <p style="margin-top: 25px;"> Nessa página serão mostrados todos os calendários, para o diretor e o vice-diretor
        poderem ter controle dos dias
        letivos e úteis de toda a escola. </p>
</body>
