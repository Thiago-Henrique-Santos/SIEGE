...
<head>
    ...
    <title>SIEGE - Visão para professores </title>
    ...
    <div class="flex-container">
        ...
        <main>
            ...
            flex-flow: row nowrap; justify-content: center;">
                <h1 class="titulo-principal"> Página principal para professores </h1>
            </div>
            <p>Nesta página irá conter a visão inicial dos professores, com o menu para abrir
                cada aba(adicionar notas, visualizar boletins, visualizar ranking, visualizar turmas virtuais e
                adicionar o que foi dado em aula).</p>
        </main>
    </div>
    <br><br>
