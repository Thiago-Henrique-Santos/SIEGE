...
if ($_SESSION['tip_usu'] != 1) {
    ...
    $sql = "SELECT b.nota1bim AS 'nota1', b.nota2bim AS 'nota2', b.nota3bim AS 'nota3', b.nota4bim AS 'nota4', 
        ...
        b.notaRecuperacao AS 'nota_r', b.faltaRecuperacao AS 'falta_r', b.id AS 'id_boletim', u.nome AS 'aluno', u.sexo AS 'sexo' FROM boletim b INNER JOIN usuario u ON b.id_aluno = u.id INNER JOIN aluno a ON a.idAluno = u.id 
