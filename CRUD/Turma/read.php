<?php
    ...
    if($_SESSION['tip_usu'] != 1 ){
        ...
        $sql = "SELECT t.id AS 'id_turma', t.serie AS 'serie', t.nome AS 'nome_turma' FROM turma t, usuario u, aluno a WHERE t.id=a.id_turma AND u.id=a.idAluno AND t.id != 1 AND u.email = '" . $_SESSION['campo_email'] . "'";
