        ...
        if (isset($_GET['dir']) || isset($_GET['secr']) || isset($_GET['sup']) || isset($_GET['prof']) || isset($_GET['alu'])) {
            ...
            if ($resultado0->num_rows > 0){
                ...
                do{
                    $continua = 0;
                    for ($l=0; $l<($fim-1); $l++){
                        if(strnatcmp($registros['usuario'][$l]['nome'], $registros['usuario'][$l+1]['nome']) > 0){
                            $aux = $registros['usuario'][$l]['idtf'];
                            $registros['usuario'][$l]['idtf'] = $registros['usuario'][$l+1]['idtf'];
                            $registros['usuario'][$l+1]['idtf'] = $aux;

                            $aux = $registros['usuario'][$l]['nome'];
                            $registros['usuario'][$l]['nome'] = $registros['usuario'][$l+1]['nome'];
                            $registros['usuario'][$l+1]['nome'] = $aux;

                            $aux = $registros['usuario'][$l]['email'];
                            $registros['usuario'][$l]['email'] = $registros['usuario'][$l+1]['email'];
                            $registros['usuario'][$l+1]['email'] = $aux;

                            $aux = $registros['usuario'][$l]['local_moradia'];
                            $registros['usuario'][$l]['local_moradia'] = $registros['usuario'][$l+1]['local_moradia'];
                            $registros['usuario'][$l+1]['local_moradia'] = $aux;

                            $aux = $registros['usuario'][$l]['sexo'];
                            $registros['usuario'][$l]['sexo'] = $registros['usuario'][$l+1]['sexo'];
                            $registros['usuario'][$l+1]['sexo'] = $aux;

                            if($registros['usuario'][$l]['cargo_info']['ocupacao'] == 'aluno'){
                                $aux = $registros['usuario'][$l]['cargo_info']['data_nascimento'];
                                $registros['usuario'][$l]['cargo_info']['data_nascimento'] = $registros['usuario'][$l+1]['cargo_info']['data_nascimento'];
                                $registros['usuario'][$l+1]['cargo_info']['data_nascimento'] = $aux;

                                $aux = $registros['usuario'][$l]['cargo_info']['matricula'];
                                $registros['usuario'][$l]['cargo_info']['matricula'] = $registros['usuario'][$l+1]['cargo_info']['matricula'];
                                $registros['usuario'][$l+1]['cargo_info']['matricula'] = $aux;

                                $aux = $registros['usuario'][$l]['cargo_info']['responsavel'];
                                $registros['usuario'][$l]['cargo_info']['responsavel'] = $registros['usuario'][$l+1]['cargo_info']['responsavel'];
                                $registros['usuario'][$l+1]['cargo_info']['responsavel'] = $aux;

                                $aux = $registros['usuario'][$l]['cargo_info']['turma']['idtf'];
                                $registros['usuario'][$l]['cargo_info']['turma']['idtf'] = $registros['usuario'][$l+1]['cargo_info']['turma']['idtf'];
                                $registros['usuario'][$l+1]['cargo_info']['turma']['idtf'] = $aux;

                                $aux = $registros['usuario'][$l]['cargo_info']['turma']['serie'];
                                $registros['usuario'][$l]['cargo_info']['turma']['serie'] = $registros['usuario'][$l+1]['cargo_info']['turma']['serie'];
                                $registros['usuario'][$l+1]['cargo_info']['turma']['serie'] = $aux;

                                $aux = $registros['usuario'][$l]['cargo_info']['turma']['nome'];
                                $registros['usuario'][$l]['cargo_info']['turma']['nome'] = $registros['usuario'][$l+1]['cargo_info']['turma']['nome'];
                                $registros['usuario'][$l+1]['cargo_info']['turma']['nome'] = $aux;

                                $aux = $registros['usuario'][$l]['cargo_info']['ocupacao'];
                                $registros['usuario'][$l]['cargo_info']['ocupacao'] = $registros['usuario'][$l+1]['cargo_info']['ocupacao'];
                                $registros['usuario'][$l+1]['cargo_info']['ocupacao'] = $aux;

                            }elseif($registros['usuario'][$l]['cargo_info']['ocupacao'] == 'professor'){
                                $aux = $registros['usuario'][$l]['cargo_info']['masp'];
                                $registros['usuario'][$l]['cargo_info']['masp'] = $registros['usuario'][$l+1]['cargo_info']['masp'];
                                $registros['usuario'][$l+1]['cargo_info']['masp'] = $aux;

                                $aux = $registros['usuario'][$l]['cargo_info']['tipo_empregado'];
                                $registros['usuario'][$l]['cargo_info']['tipo_empregado'] = $registros['usuario'][$l+1]['cargo_info']['tipo_empregado'];
                                $registros['usuario'][$l+1]['cargo_info']['tipo_empregado'] = $aux;

                                $aux = $registros['usuario'][$l]['cargo_info']['funcao'];
                                $registros['usuario'][$l]['cargo_info']['funcao'] = $registros['usuario'][$l+1]['cargo_info']['funcao'];
                                $registros['usuario'][$l+1]['cargo_info']['funcao'] = $aux;

                                $aux = $registros['usuario'][$l]['cargo_info']['ocupacao'];
                                $registros['usuario'][$l]['cargo_info']['ocupacao'] = $registros['usuario'][$l+1]['cargo_info']['ocupacao'];
                                $registros['usuario'][$l+1]['cargo_info']['ocupacao'] = $aux;

                            }elseif($registros['usuario'][$l]['cargo_info']['ocupacao'] == 'diretor'){
                                $aux = $registros['usuario'][$l]['cargo_info']['masp'];
                                $registros['usuario'][$l]['cargo_info']['masp'] = $registros['usuario'][$l+1]['cargo_info']['masp'];
                                $registros['usuario'][$l+1]['cargo_info']['masp'] = $aux;
                            ...
                            }elseif($registros['usuario'][$l+1]['cargo_info']['ocupacao'] == 'aluno'){
                                $aux = $registros['usuario'][$l]['cargo_info']['data_nascimento'];
                                $registros['usuario'][$l]['cargo_info']['data_nascimento'] = $registros['usuario'][$l+1]['cargo_info']['data_nascimento'];
                                $registros['usuario'][$l+1]['cargo_info']['data_nascimento'] = $aux;
                            ...
                            }elseif($registros['usuario'][$l+1]['cargo_info']['ocupacao'] == 'professor'){
                                $aux = $registros['usuario'][$l]['cargo_info']['masp'];
                                $registros['usuario'][$l]['cargo_info']['masp'] = $registros['usuario'][$l+1]['cargo_info']['masp'];
                                $registros['usuario'][$l+1]['cargo_info']['masp'] = $aux;
                            ...
                            }elseif($registros['usuario'][$l+1]['cargo_info']['ocupacao'] == 'diretor'){
                                $aux = $registros['usuario'][$l]['cargo_info']['masp'];
                                $registros['usuario'][$l]['cargo_info']['masp'] = $registros['usuario'][$l+1]['cargo_info']['masp'];
                                $registros['usuario'][$l+1]['cargo_info']['masp'] = $aux;
